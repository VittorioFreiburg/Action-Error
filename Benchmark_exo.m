...
figure('Name', 'System Dynamics & Ablations', 'Position', [100, 100, 1300, 850]);
...
plot(0:demo_steps, x_ref_deploy(1:demo_steps+1), ':', 'Color', c_ref, 'LineWidth', 2.5, 'DisplayName', 'Reference Trajectory');
...
plot(0:demo_steps, x_ref_deploy(1:demo_steps+1), ':', 'Color', c_ref, 'LineWidth', 2.5, 'HandleVisibility', 'off');
plot(0:demo_steps, x_on,  '-', 'Color', c_on,  'LineWidth', 2.5, 'DisplayName', 'Online NN (Optimal Ref)');
...
plot(x_on(1:end-1),  x_on(2:end),  '-', 'Color', c_on,  'LineWidth', 2.0, 'DisplayName', 'Online NN (Ref)');
